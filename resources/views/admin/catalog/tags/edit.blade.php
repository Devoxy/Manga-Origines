...
<div class="page-header">
    <h1>
        Gestion des tags
        <small><i class="ace-icon fa fa-angle-double-right"></i> Éditer un tag</small>
    </h1>
</div>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="bootstrap-colorpicker">
                        <input id="color" name="color" type="text" class="col-xs-10 col-sm-5 @error('color') is-invalid @enderror"  value="{{ $data->color }}">
                    </div>
                </div>
            </div>
